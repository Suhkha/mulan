...
@section('title-section-admin')Nueva categoría @stop
	...
	<form class="form-horizontal" method="post" action="{{ route('admin.categories.store') }}">
		...
		<fieldset>
			<div class="form-group">
				...
				<div class="col-lg-3">
					<input type="text" class="form-control" id="inputName" name="name" placeholder="Nombre de categoría" value="{{ old('name') }}">
					@if ($errors->has('name'))
