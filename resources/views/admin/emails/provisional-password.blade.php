...
<table border="0" cellpadding="0" cellspacing="0" class="mobile-padding" style="background-color: #EFEFEF; margin: 0; padding: 0" width="100%">
        <tr>
            <td align="center" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" class="100p" width="640">
                    ...
                    <tr>
                        <td align="right" style="font-size:11px; color:#333333; font-family:Arial, Helvetica, sans-serif;">
                            Email looking strange? <a href="##" style="color:#ad2f70; text-decoration:none;">View it in browser</a>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left" style="font-size:24px; color:#ad2f70; font-family:Helvetica, Arial, sans-serif;">Bienvenido(a) a Jájki / Welcome to Jájki</td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" class="font-bump" style="font-size:14px; color:#333333; font-family:Arial, Helvetica, sans-serif;">
                                        Tu cuenta ha sido creada correctamente con la ayuda del equipo de Jájki.<br>
                                        <br>
                                        Por favor, por seguridad cambia tu contraseña desde <a href="{{url('/password/resest')}}">aquí</a>.<br>
                                        Si tienes dudas, contáctanos.
                                        <br><br>
                                        Con amor... Jájki. 
                                        <br><br><br>

                                        Your account has been created successfully with the help of Jájki's team.<br>
                                        Please, for security, change your password from <a href="{{url('/password/reset')}}">here</a>.<br>
